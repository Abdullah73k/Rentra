...
export function validateTransactionDetails<T extends PostCreateTransaction | PatchTransaction>(transaction: T, patch: boolean = false) {
  const schema = patch ? patchTransactionValidationSchema : postTransactionValidationSchema
