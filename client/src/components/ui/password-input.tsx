      ...
      <div className="space-y-3">
        <div className="relative">
          <Input
            ...
            className={cn(
              "h-12 rounded-lg border-gray-300 bg-white pr-11 text-sm focus-visible:ring-1 focus-visible:ring-black",
              className,
            )}
          />
          <button
            ...
            className="absolute inset-y-0 right-3 inline-flex items-center justify-center text-gray-500 hover:text-black focus-visible:outline-none"
          >
